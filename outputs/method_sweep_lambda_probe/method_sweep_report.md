...
- Sion appears in 23/25 method-summary best pools. Pantheon appears in 18/25 method-summary best pools.
...
- `opgg_plat_plus_16.06`: opgg_patch_folder, patch 16.06, rank plat_plus, role mid, retrieved 2026-04-07; [representative URL](https://op.gg/lol/champions/ahri/build/mid?region=global&tier=platinum_plus&patch=16.06). Local matchup file: `C:\Users\gosee\Documents\codex\lol_pool_optimizer\data\16.06\opgg_mid_matchups_clean.csv`.
- `opgg_emerald_plus_16.07`: opgg_local_extract, patch 16.07, rank emerald_plus, role mid, retrieved 2026-04-05; [representative URL](https://op.gg/lol/champions/ahri/build/mid?region=global&tier=emerald_plus). Local matchup file: `..\data\opgg_mid_matchups.csv`.
- `opgg_plat_plus_16.07`: opgg_patch_folder, patch 16.07, rank plat_plus, role mid, retrieved 2026-04-07; [representative URL](https://op.gg/lol/champions/malzahar/build/mid?region=global&tier=platinum_plus&patch=16.07). Local matchup file: `C:\Users\gosee\Documents\codex\lol_pool_optimizer\data\16.07\opgg_mid_matchups_clean.csv`.
...
- First offmeta lambda removing Sion from the best pool: `0.1`. For Pantheon: `0.025`.

## Focus Champion Scope Stability

- **Sion:** best-pool member in 8/12 scope rows; median top-pool share 85.00%.
- **Pantheon:** best-pool member in 6/12 scope rows; median top-pool share 17.50%.
